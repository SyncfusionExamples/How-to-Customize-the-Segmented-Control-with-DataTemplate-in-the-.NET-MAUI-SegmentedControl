# How to Customize the Segmented Control with DataTemplate in the .NET MAUI SegmentedControl

This repository contains the sample code to customize the segmented control with data template in the [SfSegmentedControl](https://help.syncfusion.com/maui/segmented-control/getting-started).
